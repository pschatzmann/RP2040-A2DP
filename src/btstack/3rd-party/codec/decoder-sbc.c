...
#include "btstack/3rd-party/codec/oi_codec_sbc_private.h"
#include "btstack/3rd-party/codec/oi_bitstream.h"
...
#include "btstack/3rd-party/codec/readsamplesjoint.inc"
#undef NROF_SUBBANDS
}
